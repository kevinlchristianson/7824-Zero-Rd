...
- **Heat pump setups.** No Apollo is bought yet. The plan compares one 3.5-ton, one 6-ton, 3.5 + 6, and two 6-tons, each on the existing 6-ton AHU or with a second 3.5-ton AHU. With one AHU the upper-level hydronic floor carries part of the upstairs heat and needs hot water, which lowers the heat pump's COP. There are three heating modes. Cool-only leaves heat to the boiler. Heat-first runs the heat pump whenever it can. Smart spends solar credit that would otherwise be paid out at the true-up on the best-COP hours, plus any hour the heat pump beats gas outright. Each setup gets its cheapest array and is ranked by 25-year cost.
